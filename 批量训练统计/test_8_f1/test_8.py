...
import os
import time
# /home/yanchenxu/1d-test-NNpotential/批量训练统计
...
if __name__ == "__main__":
    ...
    for execution in range(exe_num):
        ...
        os.makedirs(f'/home/yanchenxu/1d-test-NNpotential/批量训练统计/{file_name}/model_{execution+1}', exist_ok=True)
        ...
        torch.save(model.state_dict(),f'/home/yanchenxu/1d-test-NNpotential/批量训练统计/{file_name}/model_{execution+1}/model_para.pth')
        ...
        poten_loss_list.append(loss_fn(NN_poten,real_poten).item())
        ...
        plt.legend()
        plt.savefig(f'/home/yanchenxu/1d-test-NNpotential/批量训练统计/{file_name}/model_{execution+1}/poten_20_2000.png')
        plt.clf()
        ...
        plt.title(f'loss={final_loss:.4f} , epoch={final_epoch} , time={final_time:.2f}s')
        plt.legend()
        plt.savefig(f'/home/yanchenxu/1d-test-NNpotential/批量训练统计/{file_name}/model_{execution+1}/poten_0_20.png')
        plt.clf()
        ...
        plt.title(f'loss={final_loss:.4f} , epoch={final_epoch} , time={final_time:.2f}s')
        plt.legend()
        plt.savefig(f'/home/yanchenxu/1d-test-NNpotential/批量训练统计/{file_name}/model_{execution+1}/eigenvalue.png')
        plt.clf()
    ...
    plt.title(f'loss={final_loss:.4f} , epoch={final_epoch} , time={final_time:.2f}s')
    plt.legend()
    plt.savefig(f'/home/yanchenxu/1d-test-NNpotential/批量训练统计/{file_name}/eig_loss.png')
    plt.clf()

    plt.plot(poten_loss_list,label='poten_loss')
    plt.title(f'loss={final_loss:.4f} , epoch={final_epoch} , time={final_time:.2f}s')
    plt.legend()
    plt.savefig(f'/home/yanchenxu/1d-test-NNpotential/批量训练统计/{file_name}/poten_loss.png')
    plt.clf()
